...
class nhop(Model):
    def __init__(self, n_out = 3, n_sigs=2, hidden_states=64, conv_layers=1, conv_activation='relu', decode_layers=2, decode_activation=1, regularization=None, dropout=0.2, batch_norm=True, forward=True):
        super().__init__()
        self.n_out=n_out
        self.n_sigs=n_sigs
